                    ...
                    <div class="card-header pb-0 d-flex justify-content-between align-items-center bg-white">
                        <div class="d-flex align-items-center">
                            ...
                            <h5 class="mb-0">
                                ...
                                <strong>GESTION DE CATEGORIAS</strong>
                            </h5>
                        </div>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="dropdown me-2">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="exportDropdown">
                                    <li>
                                        <a class="dropdown-item" href="{{ route('admin.categorias.reporte') }}?tipo=pdf"
                                            title="Exportar a PDF" target="_blank">
                                            <i class="fas fa-file-pdf text-danger me-2"></i> PDF
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="{{ route('admin.categorias.reporte') }}?tipo=excel"
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="align-middle">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <span
                                                                class="text-dark text-sm font-weight-bold">{{ $categoria->nombre }}</span>
                                                        </div>
                                                    </td>
                                                    <td class="align-middle">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="input-group input-group-outline">
                                        ...
                                        <input type="text" class="form-control" name="nombre" value="{{ old('nombre') }}"
                                            required placeholder="Ej: Higiene">
                                    </div>
                                    @error('nombre')

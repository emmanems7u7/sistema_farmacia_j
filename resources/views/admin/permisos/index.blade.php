                                ...
                                @foreach($permisos as $permiso)
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <div class="d-flex align-items-center">
                                                <div
                                                    class="icon icon-shape icon-sm bg-gradient-info shadow text-center rounded-circle me-3">
                                                    <i class="fas fa-shield-alt text-white opacity-10"></i>
                                                </div>
                                                <div>
                                                    <span
                                                        class="text-dark text-sm font-weight-bold mb-0">{{ $permiso->name }}</span>
                                                    <p class="text-xs text-secondary mb-0">Creado:
                                                        {{ $permiso->created_at->format('d/m/Y') }}</p>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="text-center align-middle">
                                            <div class="btn-group" role="group">
                                                ...
                                                <form action="{{ route('admin.permisos.destroy', $permiso->id) }}" method="POST"
                                                    class="d-inline" data-permiso='{"nombre":"{{ $permiso->nombre }}"}'>
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="button"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-outline">
                                    ...
                                    <input type="text" class="form-control border-bottom" name="name"
                                        value="{{ old('name') }}" required placeholder="Ej: gestionar-usuarios">
                                </div>
                        ...
                        <form action="{{ url('/admin/permisos', $permiso->id) }}" method="POST">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-outline">
                                        <span class="input-group-text bg-transparent"><i
                                                class="fas fa-key text-success"></i></span>

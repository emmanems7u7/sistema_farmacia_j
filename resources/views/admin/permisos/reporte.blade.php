        ...
        <div class="card border-0">
            ...
            <div class="card-body py-2">  <!-- Reducido padding vertical -->
                <div class="d-flex justify-content-between align-items-center">
                    <p class="mb-0 small">Total: <span class="badge bg-primary">{{ count($compras) }}</span></p>  <!-- Texto más pequeño -->
                    <div class="d-flex gap-2">
                        <button class="btn btn-sm btn-outline-secondary px-2" id="refreshTable">  <!-- Padding horizontal reducido -->
                            <i class="fas fa-sync-alt me-1"></i> Actualizar
                        </button>
                        <div class="dropdown">
                            <button class="btn btn-icon btn-outline-primary  dropdown-toggle" 
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        ...
                                        <div id="details-{{ $compra->id }}" class="details-content" style="display: none;">
                                    ...
                                    <td class="align-middle">{{ \Carbon\Carbon::parse($compra->fecha)->format('d/m/Y') }}</td>
...
<form action="{{ route('admin.compras.destroy', $compra->id) }}" 
      method="POST" 
      class="d-inline eliminar-compra-form"
      data-id="{{ $compra->id }}"

...
<div class="row">
    ...
    <div class="card card-hover h-100 border-0 shadow-xs">
        <div class="card-header bg-white d-flex justify-content-between align-items-center border-bottom pb-3">
            <div class="d-flex align-items-center">
                <div class="icon icon-shape bg-gradient-info shadow-info text-center rounded-circle me-2">
        ...
        <div class="card-body pt-3 pb-2">
            <h6 class="text-xs text-uppercase text-muted mb-3">Permisos asignados ({{ $role->permissions_count }})</h6>

        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    alertify.error(response.message || 'Error al eliminar');
                }
            },
                    ...
                    if (codigo.length > 0) {
                        ...
                        success: function(response) {
                            if (response.success) {
                                ...
                                alertify.error(response.message || 'Error al agregar');
                            }
                        },
        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                ...
                <form action="{{ url('/admin/compras', $compra->id) }}" method="post" id="form_compra">
                    @csrf
                    @method('PUT')
                    <input type="hidden" name="id_compra"  id="id_compra"  value="{{ $compra->id }}">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach($compra->detalles as $detalle)
                                                    <tr>
                                                        ...
                                                        @endphp
                                                        <td class="text-end px-2 py-1">Bs{{ number_format($precioCompra, 2) }}
                                                        </td>
                                                        <td class="text-end px-2 py-1 fw-semibold">
                                                            Bs{{ number_format($costo, 2) }}</td>
                                                        <td class="text-center px-2 py-1">
                                                            <button type="button"
                            ...
                            <div class="card shadow-sm mb-4 border-0">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <button type="button"
                                                ...
                                                data-bs-toggle="modal" data-bs-target="#labModal" style="min-width: 120px;">
                                                <i class="fas fa-search me-1"></i> Buscar
                                            </button>
                                            <input type="text" class="form-control border-start-0 rounded-start-0"
                                                value="{{ $compra->laboratorio->nombre }}" id="nombre_laboratorio" readonly
                                                style="height: calc(2.5rem + 2px);">
                                            <input type="hidden" name="laboratorio_id"
                                                value="{{ $compra->laboratorio->id }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text"
                                            class="form-control text-center bg-gradient-danger text-white fw-bold fs-5"

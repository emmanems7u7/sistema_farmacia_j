                            ...
                            <div class="row g-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-outline">
                                            <input type="datetime-local" class="form-control border-bottom px-0"
                                                ...
                                                name="fecha_apertura" min="{{ now()->format('Y-m-d\TH:i') }}" required>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-outline">
                                            ...
                                            <input type="number" step="0.01" class="form-control border-bottom px-0"
                                                value="{{ old('monto_inicial') }}" name="monto_inicial" required>
                                        </div>
                                        @error('monto_inicial')
                                            <small class="text-danger mt-2 d-block">{{$message}}</small>
                                        @enderror
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-outline">
                                            <input type="text" class="form-control border-bottom px-0" name="descripcion"
                                                required autocomplete="new-descripcion">
                                        </div>
                                        @error('descripcion')
                                            <small class="text-danger mt-2 d-block">{{$message}}</small>
                                        @enderror

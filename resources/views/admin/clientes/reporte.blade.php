...
<div class="compact-header">
    ...
    <div>
        <h1 class="compact-title">REPORTE DE CLIENTES</h1>
    ...
    <table>
        ...
        <tbody>
            @foreach($clientes as $index => $clientes)
            <tr>
                <td>{{ $index + 1 }}</td>
                <td>{{ $clientes->nombre_cliente ?? 'S/D' }}</td>
                <td>{{ $clientes->nit_ci ?? 'S/D' }}</td>
                <td>{{ $clientes->celular?? 'S/D'  }}</td>
                <td>{{ $clientes->email ?? 'S/D' }}</td>

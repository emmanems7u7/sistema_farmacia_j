                    ...
                    <div class="col-md-4">
                        <div class="card border-0 shadow-sm rounded-3 h-100 hover-scale">
                            <div class="card-body p-3">
                                <div class="d-flex align-items-center">
                                    <div
                                        class="icon-shape bg-primary bg-opacity-10 text-primary rounded-3 p-3 me-3 d-flex align-items-center justify-content-center">
                    ...
                    <div class="col-md-4">
                        <div class="card border-0 shadow-sm rounded-3 h-100 hover-scale">
                            <div class="card-body p-3">
                                <div class="d-flex align-items-center">
                                    <div
                                        class="icon-shape bg-success bg-opacity-10 text-success rounded-3 p-3 me-3 d-flex align-items-center justify-content-center">
                    ...
                    <div class="col-md-4">
                        <div class="card border-0 shadow-sm rounded-3 h-100 hover-scale">
                            <div class="card-body p-3">
                                <div class="d-flex align-items-center">
                                    <div
                                        class="icon-shape bg-info bg-opacity-10 text-info rounded-3 p-3 me-3 d-flex align-items-center justify-content-center">
                                        <i class="fas fa-calendar-alt fs-2"></i>
                                    </div>
                                    <div>
                                        <h6 class="text-uppercase text-muted mb-1 fs-7">Mes Actual</h6>
                                        <h2 class="mb-0 text-dark">Bs{{ number_format($ventas->whereBetween(
        'fecha',
                                    ...
                                    @foreach($ventas as $index => $venta)
                                        <tr>
                                            ...
                                            <td class="align-middle text-success font-weight-bold">
                                                Bs{{ number_format($venta->precio_total, 2) }}</td>

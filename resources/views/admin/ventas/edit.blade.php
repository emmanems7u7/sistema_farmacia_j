...
@section('content')
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="codigo" type="text" class="form-control form-control-lg" name="codigo"
                                    ...
                                    @foreach($venta->detallesVenta as $detalle)
                                        <tr>
                                            <td class="text-center">
                                                <span class="text-secondary text-xs font-weight-bold">{{$cont++}}
                                            </td>
                                            <td class="text-center">
                                                <span
                                                    class="text-secondary text-xs font-weight-bold">{{$detalle->producto->codigo}}
                                            </td>
                                            <td class="text-center">
                                                <span class="text-secondary text-xs font-weight-bold">{{$detalle->cantidad}}
                                            </td>
                                            <td> <span
                                                    class="text-secondary text-xs font-weight-bold">{{$detalle->producto->nombre}}
                                            </td>
                                            @php
                                            ...
                                            <td class="text-center">
                                                <span class="text-secondary text-xs font-weight-bold">Bs
                    ...
                    <div class="card-body">
                        <form action="{{url('/admin/ventas', $venta->id) }}" id="form_venta" method="post">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="d-flex gap-2 mb-3">
                                    ...
                                    <button type="button" class="btn btn-success flex-grow-1" data-bs-toggle="modal"
                                        data-bs-target="#clientecrearModal">
                                        <i class="fas fa-plus me-2"></i>Nuevo
                                    </button>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nombre_cliente_select"
                                        value="{{$venta->cliente->nombre_cliente ?? 'S/N'}}" disabled>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nit_cliente_select"
                                        value="{{$venta->cliente->nit_ci ?? 'SIN'}}" disabled>
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text"
                                    class="form-control form-control-lg text-center fw-bold text-white bg-success"
                        ...
                        <tbody>
                            ...
                            @foreach($productos as $producto)
                                <tr>
                                    <td>{{ $contador++ }}</td>
                                    <td class="text-center">
                                        <button type="button" class="btn btn-sm btn-info seleccionar-btn"
                                    ...
                                    <td style="color: red; font-weight: bold;">Bs {{number_format($producto->precio_venta, 2)}}
                                    </td>
                                    <td style="color: red; font-weight: bold;">{{ $producto->fecha_vencimiento }}</td>
                                    <td class="text-center">
                                        @if($producto->imagen)
                                            <img src="{{ asset('storage/' . $producto->imagen) }}" width="80" height="80"
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="btn btn-sm btn-info seleccionar-btn-cliente"
                                            data-id="{{$cliente->id}}" data-nit="{{$cliente->nit_ci}}"
    ...
    <!-- Modal Crear Cliente -->
    <div class="modal fade" id="clientecrearModal" tabindex="-1" aria-labelledby="clientecrearModalLabel"
        aria-hidden="true">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nombre_cliente"
                                    value="{{ old('nombre_cliente') }}" placeholder="Nombre completo">
